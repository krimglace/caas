...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Template Name Card</li>
        </ol>
    </nav>
    <!--/banner-section-->
    <!-- template -->
    <div class="agileits-services py-md-5" id="gallery">
        <div class="container py-lg-5 pt-3 pb-5">
            <h3 class="agile-title text-uppercase">Template Name Card</h3>
            ...
            <div class="row py-lg-5 pt-3 d-flex justify-content-center">
                <div class="card col-lg-4 border-0 mt-lg-0 mt-3">
                    ...
                    <img class="card-img-top" src="images/1.2.png" alt="Card image cap ">
                    <div class="card-body text-center">
                        <h5 class="card-title">Name Card #1</h5>
                        <a href="namecard" class="btn">Order Now</a>
                    </div>
                </div>
                <div class="card col-lg-4 border-0 mt-lg-0 mt-5">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">Name Card #2</h5>
                        <a href="namecard" class="btn">Order Now</a>
                    </div>
                </div>
                <div class="card col-lg-4  border-0 mt-lg-0 mt-5">
                    <img class="card-img-top" src="images/4.1.png" alt="Card image cap ">
                    <img class="card-img-top" src="images/4.2.png" alt="Card image cap ">
                    <div class="card-body text-center">
                        <h5 class="card-title ">Name Card #3</h5>
                        <a href="namecard" class="btn">Order Now</a>
                    </div>
                </div>
            </div>
